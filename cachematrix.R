...
## Function “makeCacheMatrix” creates a special “matrix” object that can cache its inverse. makeCacheMatrix contains 
...
##data gets the matrix stored with makeCacheMatrix, m calculates the inverse, and x$setmean(m) stores it in the 
##object m in makeCacheMatrix.Function “cacheSolve” computes the inverse of the special “matrix” 
##(which is the input of cachemean) returned by makeCacheMatrix above. If the inverse has already been calculated 
